		...
		>
			...
			<div className="vp-edit__body" style={{ overflowY: "auto", flex: "1 1 auto", minHeight: 0 }}>
				...
				<div className="vp-edit__history">
					<button className="vp-edit__btn" disabled={collaboration ? !collaboration.connected : !history.canUndo} onClick={undo}>
						<IconArrowBackUp size={15} /> Undo
					</button>
					<button className="vp-edit__btn" disabled={Boolean(collaboration) || !history.canRedo} onClick={redo}>
